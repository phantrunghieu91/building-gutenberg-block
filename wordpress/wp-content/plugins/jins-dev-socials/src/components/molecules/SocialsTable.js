...
const SocialsTable = ( { socials, onRemove, onEdit } ) => {
  return (
        ...
        <tbody>
          ...
          { socials.map( ( social, index ) => (
            <tr key={ index }>
              ...
              <td>
                <Button icon={ EditIcon } size={'small'} onClick={ () => onEdit( index ) } iconPosition={'left'}>
                  Edit
                </Button>
                <Button icon={RemoveIcon} size={'small'} isDestructive onClick={ () => onRemove( index ) }>
                  Remove
                </Button>
              </td>
            </tr>
